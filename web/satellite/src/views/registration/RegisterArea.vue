                ...
                >
                    ...
                    <div v-if="isBetaSatellite" class="register-area__input-area__container__warning">
                        ...
                        <p class="register-area__input-area__container__warning__message">
                            ...
                            <a href="https://storx/signup/" target="_blank" rel="noopener noreferrer">https://storx/signup/</a>
                        </p>
                    </div>
                    ...
                    <div class="register-area__input-area__container__checkbox-area">
                        ...
                        <label class="register-area__input-area__container__checkbox-area__msg-box" for="terms">
                            <p class="register-area__input-area__container__checkbox-area__msg-box__msg">
                                I agree to the
                                <a class="register-area__input-area__container__checkbox-area__msg-box__msg__link" href="https://storx/terms-of-service/" target="_blank" rel="noopener">Terms of Service</a>
                                and
                                <a class="register-area__input-area__container__checkbox-area__msg-box__msg__link" href="https://storx/privacy-policy/" target="_blank" rel="noopener">Privacy Policy</a>
                            </p>
                        </label>
                    </div>
                    <VueRecaptcha
...
import LogoWithPartnerIcon from '../../../static/images/partnerStorxLogo.svg';
