...
const shareButtons = computed((): ShareButtonConfig[] => {
    return [
        new ShareButtonConfig(
            ShareOptions.Reddit,
            '#5f99cf',
            `https://reddit.com/submit/?url=${props.link}&resubmit=true&title=Shared%20using%20Storx%20Decentralized%20Cloud%20Storage`,
        ...
        new ShareButtonConfig(
            ...
            '#55acee',
            `https://twitter.com/intent/tweet/?text=Shared%20using%20Storx%20Decentralized%20Cloud%20Storage&url=${props.link}`,
            images[ShareOptions.Twitter],
        ),
        new ShareButtonConfig(
            ShareOptions.HackerNews,
            '#f60',
            `https://news.ycombinator.com/submitlink?u=${props.link}&t=Shared%20using%20Storx%20Decentralized%20Cloud%20Storage`,
            images[ShareOptions.HackerNews],
        ),
        new ShareButtonConfig(
            ShareOptions.LinkedIn,
            '#0077b5',
            `https://www.linkedin.com/shareArticle?mini=true&url=${props.link}&title=Shared%20using%20Storx%20Decentralized%20Cloud%20Storage&summary=Shared%20using%20Storx%20Decentralized%20Cloud%20Storage&source=${props.link}`,
            images[ShareOptions.LinkedIn],
        ),
        new ShareButtonConfig(
            ShareOptions.Telegram,
            '#54a9eb',
            `https://telegram.me/share/url?text=Shared%20using%20Storx%20Decentralized%20Cloud%20Storage&url=${props.link}`,
            images[ShareOptions.Telegram],
        ),
        new ShareButtonConfig(
            ShareOptions.WhatsApp,
            '#25d366',
            `whatsapp://send?text=Shared%20using%20Storx%20Decentralized%20Cloud%20Storage%20${props.link}`,
            images[ShareOptions.WhatsApp],
        ),
        new ShareButtonConfig(
            ShareOptions.Email,
            '#777',
            `mailto:?subject=Shared%20using%20Storx%20Decentralized%20Cloud%20Storage&body=${props.link}`,
