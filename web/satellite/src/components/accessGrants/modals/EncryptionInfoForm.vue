...
<template>
    <div class="info">
        ...
        <p class="info__info">
            By generating S3 credentials, you are opting in to <a class="info__info__link" href="https://docs.storx/dcs/concepts/encryption-key/design-decision-server-side-encryption/" target="_blank" rel="noopener noreferrer">server-side encryption</a>.
        </p>
        <VCheckbox
