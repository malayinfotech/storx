...
<template>
    <div class="create-access">
            ...
            <div class="create-access__fragment__wrap">
                ...
                <div class="create-access__fragment__wrap__type-container">
                    ...
                    <div
                        ...
                        @mouseleave="toggleTooltipHover('access','leave')"
                    >
                        <span class="tooltip-text">Keys to upload, delete, and view your project's data.  <a class="tooltip-link" href="https://docs.storx/dcs/concepts/access/access-grants" target="_blank" rel="noreferrer noopener" @click="trackPageVisit('https://docs.storx/dcs/concepts/access/access-grants')">Learn More</a></span>
                    </div>
                </div>
                <div class="create-access__fragment__wrap__type-container">
                    <label class="checkmark-container">
                ...
                <div class="create-access__fragment__wrap__type-container">
                    ...
                    <div
                        ...
                        @mouseleave="toggleTooltipHover('api','leave')"
                    >
                        <span class="tooltip-text">Creates access grant to run in the command line.  <a class="tooltip-link" href="https://docs.storx/dcs/getting-started/quickstart-uplink-cli/generate-access-grants-and-tokens/generate-a-token" target="_blank" rel="noreferrer noopener" @click="trackPageVisit('https://docs.storx/dcs/getting-started/quickstart-uplink-cli/generate-access-grants-and-tokens/generate-a-token')">Learn More</a></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="create-access__buttons">
            <a href="https://docs.storx/dcs/concepts/access/access-grants/api-key" target="_blank" rel="noopener noreferrer" @click="trackPageVisit('https://docs.storx/dcs/concepts/access/access-grants/api-key')">
                <v-button
                    label="Learn More"
                    height="48px"
                    :is-transparent="true"
