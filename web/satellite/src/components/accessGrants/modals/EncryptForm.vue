    ...
    <div class="encrypt">
        ...
        >
            ...
            <div v-if="isPassphraseDownloaded || isPassphraseCopied" :class="`encrypt__footer-container__acknowledgement-container ${acknowledgementCheck ? 'blue-background' : ''}`">
                ...
                >
                <label for="acknowledgement" class="encrypt__footer-container__acknowledgement-container__text">I understand that Storx does not know or store my encryption passphrase. If I lose it, I won't be able to recover files.</label>
            </div>
            <div
