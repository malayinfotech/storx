    ...
    <div class="warning-step">
        <p class="warning-step__info">
            ...
            <a
                ...
                href="https://docs.storx/dcs/concepts/encryption-key/design-decision-server-side-encryption/"
                target="_blank"
...
function trackPageVisit(): void {
    analytics.pageVisit('https://docs.storx/dcs/concepts/encryption-key/design-decision-server-side-encryption/');
}
