        ...
        <div class="total-cost">
            ...
            <div class="total-cost__card-container">
                ...
                <div class="total-cost__card">
                    ...
                    <p class="total-cost__card__label-text">STORX Token Balance</p>
                    <p
                        class="total-cost__card__link-text"
                ...
                <div v-if="balance.hasCredits()" class="total-cost__card">
                    ...
                    <p class="total-cost__card__label-text">Legacy STORX Payments and Bonuses</p>
                </div>
            </div>
        </div>
...
/**
 * Returns whether the user's STORX balance is empty.
 */
