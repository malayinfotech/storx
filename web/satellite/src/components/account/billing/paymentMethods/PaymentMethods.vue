...
export default class PaymentMethods extends Vue {
    ...
    public isAddStorxClicked = false;
    ...
    public get areAddButtonsClicked(): boolean {
        return this.isAddCardClicked || this.isAddStorxClicked;
    }
     ...
     */
    public get isAddingStorxState(): boolean {
        return this.areaState === PaymentMethodsBlockState.ADDING_STORX;
    }
     ...
     */
    public onAddSTORX(): void {
        this.isAddStorxClicked = true;
        setTimeout(() => {
            this.areaState = PaymentMethodsBlockState.ADDING_STORX;
        }, 500);
    }
...
<style scoped lang="scss">
    ...
    .extended {
        height: 200px; // TODO: should be based on whether storx payment is allowed or not
        // see https://github.com/storx/storx-private/issues/43
        // height: 300px;
    }
