    ...
    <div class="token">
        ...
        <div class="token__content">
            ...
            <div v-else-if="!wallet.address" class="token__content__add-funds">
                ...
                <p class="token__content__add-funds__info">Deposit STORX Token to your account and receive a 10% bonus, or $10 for every $100.</p>
                <!-- Claim wallet button -->
                <VButton
                    label="Add STORX Tokens"
                    width="140px"
                    height="32px"
                    font-size="13px"
                    border-radius="6px"
            ...
            <template v-else>
                        ...
                        <VInfo>
                            ...
                            <template #message>
                                <p class="token__content__title-area__default-wrapper__message">
                                    If the STORX token balance runs out, the default credit card will be charged.
                                    <a
                ...
                <div class="token__content__info-area">
                    <div class="token__content__info-area__option">
                        <h2 class="token__content__info-area__option__title">STORX Token Deposit Address</h2>
...
import StorxSmall from '@/../static/images/billing/storx-icon-small.svg';
import StorxLarge from '@/../static/images/billing/storx-icon-large.svg';
...
export default class AddTokenCardNative extends Vue {
    ...
    /**
     * Called when "Add STORX Tokens" button is clicked.
     */
    public async claimWalletClick(): Promise<void> {
        ...
        try {
            ...
            await this.$notify.error(error.message, AnalyticsErrorEventSource.BILLING_STORX_TOKEN_CONTAINER);
        }
        this.isLoading = false;
    }
