            ...
            <div v-if="isAddModal" class="add-modal">
                ...
                <div v-else class="add-modal__tokens">
                    <p class="add-modal__tokens__banner">
                        Deposit STORX Token to your account and receive a 10% bonus, or $10 for every $100.
                    </p>
                    <p class="add-modal__tokens__support-info">To deposit STORX token and request higher limits, please contact <a target="_blank" rel="noopener noreferrer" href="https://supportdcs.storx/hc/en-us/requests/new?ticket_form_id=360000683212">Support</a></p>
                </div>
...
/**
 * Sets modal state to add STORX tokens.
 */
