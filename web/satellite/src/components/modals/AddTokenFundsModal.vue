    ...
    <VModal v-if="wallet.address" :on-close="closeModal">
        <template #content>
            <div class="modal">
                ...
                <p class="modal__info">
                    Send STORX Tokens to the following deposit address to credit your Storx DCS account:
                </p>
                <div class="modal__qr">
                    ...
                    <VInfo class="modal__label__info">
                        ...
                        <template #message>
                            <p class="modal__label__info__msg">
                                This is a Storx deposit address generated just for you.
                                <a
                ...
                <div class="modal__footer">
                    <h2 class="modal__footer__title">Send only STORX tokens via Layer 1 transaction to this deposit address.</h2>
                    <div class="modal__footer__msg">
                        <p>
                            Sending anything else than STORX token will result in the loss of your deposit.
                        </p>
                        <p>
