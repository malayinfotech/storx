                ...
                <template #windows>
                    <div class="cli-install__windows">
                        <h2 class="cli-install__windows__sub-title">
                            1. Download the
                            <a href="https://github.com/storx/storx/releases/latest/download/uplink_windows_amd64.zip">
                    ...
                    <div class="cli-install__linux">
                        ...
                        <div class="cli-install__linux__commands">
                            <TabWithCopy
                                ...
                                value="curl -L https://github.com/storx/storx/releases/latest/download/uplink_linux_amd64.zip -o uplink_linux_amd64.zip"
                        ...
                        <a
                            ...
                            href="https://github.com/storx/storx/releases/latest/download/uplink_linux_amd64.zip"
                        >
                        ...
                        <div class="cli-install__linux__commands">
                            <TabWithCopy
                                class="cli-install__linux__commands__item"
                                value="curl -L https://github.com/storx/storx/releases/latest/download/uplink_linux_arm.zip -o uplink_linux_arm.zip"
                        ...
                        <a
                            class="cli-install__linux__link"
                            href="https://github.com/storx/storx/releases/latest/download/uplink_linux_arm.zip"
                        >
                ...
                <template #macos>
                    <div class="cli-install__macos">
                        ...
                        <div class="cli-install__macos__commands">
                            <TabWithCopy
                                class="cli-install__linux__commands__item"
                                value="curl -L https://github.com/storx/storx/releases/latest/download/uplink_darwin_amd64.zip -o uplink_darwin_amd64.zip"
                        ...
                        <a
                            ...
                            href="https://github.com/storx/storx/releases/latest/download/uplink_darwin_amd64.zip"
                        >
                            macOS Uplink Binary
                        </a>
                    </div>
