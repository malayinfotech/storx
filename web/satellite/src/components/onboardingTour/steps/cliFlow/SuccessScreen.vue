...
<template>
    <div class="success-screen">
        ...
        <p class="success-screen__msg">
            ...
            <a class="link" href="https://docs.storx/" target="_blank" rel="noopener noreferrer">documentation</a>.
            You can also find a list of all the
            <a class="link" href="https://www.storx/integrations" target="_blank" rel="noopener noreferrer">integrations</a> on the website.
        </p>
