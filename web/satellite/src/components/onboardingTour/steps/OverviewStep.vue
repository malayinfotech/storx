...
<template>
    <div class="overview-area">
        <h1 class="overview-area__title" aria-roledescription="title">Welcome to Storx {{ titleLabel }}</h1>
        ...
        <div class="overview-area__routes">
            <OverviewContainer
                ...
                info="Start uploading files in the browser and instantly see how your data gets distributed over the Storx network around the world."
