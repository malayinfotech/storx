    ...
    <div class="overview-container">
        ...
        <p v-if="isWeb" class="overview-container__encryption-container">
            ...
            <a
                ...
                href="https://docs.storx/concepts/encryption-key/design-decision-server-side-encryption"
                target="_blank"
        ...
        <p v-else class="overview-container__encryption-container">
            ...
            <a
                class="overview-container__encryption-container__link"
                href="https://docs.storx/concepts/encryption-key/design-decision-end-to-end-encryption"
                target="_blank"
                rel="noopener noreferrer"
