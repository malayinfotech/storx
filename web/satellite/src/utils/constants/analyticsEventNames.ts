...
export enum AnalyticsEvent {
    ...
    MODAL_ADD_TOKENS = 'Storx Token Added In Modal',
    ...
    STORX_TOKEN_ADDED_FROM_BILLING = 'Storx Token Added From Billing',
...
export enum AnalyticsErrorEventSource {
    ...
    BILLING_STORX_TOKEN_CONTAINER = 'Billing STORX token container',
