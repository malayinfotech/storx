...
export class SignupPageObjects {
    ...
    // IX BRANDED SIGNUP
    protected static CREATE_ACCOUNT_BUTTON_XPATH = '//span[contains(text(),\'Create an iX-Storx Account\')]';
    protected static IX_BRANDED_HEADER_TEXT_XPATH = '//h1[contains(text(),\'Globally Distributed Storage for TrueNAS\')]';
    protected static IX_BRANDED_SUBHEADER_TEXT_XPATH = '//p[contains(text(),\'iX and Storx have partnered to offer a secure, hig\')]';
