...
func TestNavigation(t *testing.T) {
	uitest.Run(t, func(t *testing.T, ctx *testcontext.Context, planet *testplanet.Planet, browser *rod.Browser) {
		...
		docsLinkTitle := page.MustElement("[href=\"https://docs.storx/\"] div h2").MustText()
		require.Contains(t, docsLinkTitle, "Docs")
		forumLinkTitle := page.MustElement("[href=\"https://forum.storx/\"] div h2").MustText()
		require.Contains(t, forumLinkTitle, "Forum")
		supportLinkTitle := page.MustElement("[href=\"https://supportdcs.storx/hc/en-us\"] div h2").MustText()
