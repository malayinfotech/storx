...
func TestSignup_Content(t *testing.T) {
	uitest.Run(t, func(t *testing.T, ctx *testcontext.Context, planet *testplanet.Planet, browser *rod.Browser) {
		...
		usSatLink := page.MustElement("[href=\"https://us1.storx/signup\"]").MustText()
		require.Contains(t, usSatLink, "US1")
		euSatLink := page.MustElement("[href=\"https://eu1.storx/signup\"]").MustText()
		require.Contains(t, euSatLink, "EU1")
		apSatLink := page.MustElement("[href=\"https://ap1.storx/signup\"]").MustText()
