...
func (client *gracefulExitClient) gracefulExitFeasibility(ctx context.Context, id storx.NodeID) (*internalpb.GracefulExitFeasibilityResponse, error) {
...
func cmdGracefulExitInit(cmd *cobra.Command, args []string) error {
	...
	// validate user input
	satelliteIDs := make([]storx.NodeID, 0, len(satelliteList.GetSatellites()))
...
func gracefulExitInit(ctx context.Context, satelliteIDs []storx.NodeID, w *tabwriter.Writer, client *gracefulExitClient) (err error) {
