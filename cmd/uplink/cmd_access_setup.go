...
func (c *cmdAccessSetup) Setup(params clingy.Parameters) {
	c.authService = params.Flag("auth-service", "If generating backwards-compatible S3 Gateway credentials, use this auth service", "https://auth.storxshare.io").(string)
