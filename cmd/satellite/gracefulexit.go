...
func verifyGracefulExitReceipt(ctx context.Context, identity *identity.FullIdentity, nodeID storx.NodeID, receipt string) error {
...
func checkIDs(satelliteID storx.NodeID, providedSNID storx.NodeID, receiptSatelliteID storx.NodeID, receiptSNID storx.NodeID) error {
...
func writeVerificationMessage(succeeded bool, satelliteID storx.NodeID, snID storx.NodeID, timestamp time.Time) error {
