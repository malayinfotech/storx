...
func PromptForSatellite(cmd *cobra.Command) (string, error) {
	satellites := []string{
		"12EayRS2V1kEsWESU9QMRseFhdxYxKicsiFmxrsLZHeLUtdps3S@us1.storx:7777",
		"12L9ZFwhzVpuEKMUNUqkaTLGzwY9G24tbiigLiXpmZWKwmcNDDs@eu1.storx:7777",
		"121RTSDpyNZVcEU84Ticf2L1ntiuUimbWgfATz21tuvgk3vzoA6@ap1.storx:7777",
	}
...
func PromptForTracing() (bool, error) {
	_, err := fmt.Printf(`
With your permission, Storx can automatically collect analytics information from your uplink CLI to help improve the quality and performance of our products. This information is sent only with your consent and is submitted anonymously to Storx Labs: (y/n)
`)
	if err != nil {
		return false, err
	}
