...
export STORX_ACCESS="${GATEWAY_0_ACCESS}"
export UPLINK_ACCESS="${STORX_ACCESS}"
export STORX_DEBUG_ADDR="${UPLINK_DEBUG_ADDR}"
...
uplink_test() {
	...
	uplink access import -f named-access "${STORX_ACCESS}"
