...
func (service *Service) UpdateName(ctx context.Context, id storx.NodeID, name string) (err error) {
	defer mon.Task()(&ctx)(&err)
	return Error.Wrap(service.nodes.UpdateName(ctx, id, name))
}

// Get retrieves node by id.
func (service *Service) Get(ctx context.Context, id storx.NodeID) (_ Node, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (service *Service) Remove(ctx context.Context, id storx.NodeID) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (service *Service) ListInfosSatellite(ctx context.Context, satelliteID storx.NodeID) (_ []NodeInfoSatellite, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (service *Service) TrustedSatellites(ctx context.Context) (_ storx.NodeURLs, err error) {
	defer mon.Task()(&ctx)(&err)
	...
	var trustedSatellites storx.NodeURLs
...
func (service *Service) trustedSatellites(ctx context.Context, node Node) (_ storx.NodeURLs, err error) {
	defer mon.Task()(&ctx)(&err)
	...
	if err != nil {
		return storx.NodeURLs{}, ErrNodeNotReachable.Wrap(err)
	}
	...
	var nodeURLs storx.NodeURLs
	for _, url := range resp.TrustedSatellites {
		nodeURLs = append(nodeURLs, storx.NodeURL{
			ID:      url.NodeId,
...
func appendUniqueNodeURLs(slice storx.NodeURLs, nodeURLs storx.NodeURLs) storx.NodeURLs {
...
func appendUniqueNodeURL(slice storx.NodeURLs, nodeURL storx.NodeURL) storx.NodeURLs {
