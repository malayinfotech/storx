...
func (service *Service) MonthlyNode(ctx context.Context, nodeID storx.NodeID) (_ Monthly, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (service *Service) MonthlySatellite(ctx context.Context, satelliteID storx.NodeID) (_ Monthly, err error) {
	defer mon.Task()(&ctx)(&err)
	var totalMonthly Monthly
...
func (service *Service) MonthlySatelliteNode(ctx context.Context, satelliteID, nodeID storx.NodeID) (_ Monthly, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (service *Service) getMonthlySatellite(ctx context.Context, node nodes.Node, satelliteID storx.NodeID) (_ Monthly, err error) {
	defer mon.Task()(&ctx)(&err)
