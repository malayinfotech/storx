...
func (service *Service) Stats(ctx context.Context, satelliteID storx.NodeID) (_ []Stats, err error) {
...
func (service *Service) dialStats(ctx context.Context, node nodes.Node, satelliteID storx.NodeID) (_ Stats, err error) {
	defer mon.Task()(&ctx)(&err)
