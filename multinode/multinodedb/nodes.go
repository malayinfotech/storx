...
import (
	...
	"common/storx"
	"storx/multinode/multinodedb/dbx"
...
func (n *nodesdb) Get(ctx context.Context, id storx.NodeID) (_ nodes.Node, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (n *nodesdb) Remove(ctx context.Context, id storx.NodeID) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (n *nodesdb) UpdateName(ctx context.Context, id storx.NodeID, name string) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func fromDBXNode(ctx context.Context, node *dbx.Node) (_ nodes.Node, err error) {
	...
	id, err := storx.NodeIDFromBytes(node.Id)
	if err != nil {
