...
func (s *Service) GetSatelliteData(ctx context.Context, satelliteID storx.NodeID) (_ *Satellite, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (s *Service) GetSatelliteEstimatedPayout(ctx context.Context, satelliteID storx.NodeID, now time.Time) (estimatedPayout estimatedpayouts.EstimatedPayout, err error) {
...
func (s *Service) VerifySatelliteID(ctx context.Context, satelliteID storx.NodeID) (err error) {
	defer mon.Task()(&ctx)(&err)
