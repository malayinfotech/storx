...
func NewChore(log *zap.Logger, service *checker.Service, notifications *notifications.Service, nodeID storx.NodeID, checkInterval time.Duration) *Chore {
	return &Chore{
		log:           log,
		service:       service,
		nodeID:        nodeID,
...
func NewVersionNotification(timesSent notifications.TimesNotified, suggestedVersion version.SemVer, senderID storx.NodeID) (_ notifications.NewNotification) {
	switch timesSent {
