...
import (
	...
	version2 "storx/storagenode/version"
	storagenodeweb "storx/web/storagenode"
)
...
func (peer *Peer) ID() storx.NodeID { return peer.Identity.ID }

// Addr returns the public address.
func (peer *Peer) Addr() string { return peer.Server.Addr().String() }

// URL returns the storx.NodeURL.
func (peer *Peer) URL() storx.NodeURL { return storx.NodeURL{ID: peer.ID(), Address: peer.Addr()} }
