...
func NewService(log *zap.Logger, db DB, nodeID storx.NodeID, notifications *notifications.Service) *Service {
	return &Service{
		log:           log,
		db:            db,
		nodeID:        nodeID,
...
func (s *Service) Store(ctx context.Context, stats Stats, satelliteID storx.NodeID) error {
...
func newSuspensionNotification(satelliteID storx.NodeID, senderID storx.NodeID, time time.Time) (_ notifications.NewNotification) {
