...
func TestBandwidthDB(t *testing.T) {
	storagenodedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db storagenode.DB) {
		...
		satellite0 := testidentity.MustPregeneratedSignedIdentity(0, storx.LatestIDVersion()).ID
		satellite1 := testidentity.MustPregeneratedSignedIdentity(1, storx.LatestIDVersion()).ID
		...
		expectedUsageBySatellite := map[storx.NodeID]*bandwidth.Usage{
...
func TestEgressSummary(t *testing.T) {
	storagenodedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db storagenode.DB) {
		...
		expectedEgressUsageBySatellite := map[storx.NodeID]*bandwidth.Usage{
...
func TestIngressSummary(t *testing.T) {
	storagenodedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db storagenode.DB) {
		...
		expectedIngressUsageBySatellite := map[storx.NodeID]*bandwidth.Usage{
...
func TestEmptyBandwidthDB(t *testing.T) {
	storagenodedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db storagenode.DB) {
...

		{
			...
			require.NoError(t, err)
			require.Equal(t, map[storx.NodeID]*bandwidth.Usage{}, usageBySatellite)
		}

		{
			usage, err := bandwidthdb.SatelliteSummary(ctx, storx.NodeID{}, now, now)
			require.NoError(t, err)
			require.Equal(t, &bandwidth.Usage{}, usage)
		}
		...
		{
			rollups, err := bandwidthdb.GetDailySatelliteRollups(ctx, storx.NodeID{}, now, now)
			require.NoError(t, err)
			require.Equal(t, []bandwidth.UsageRollup(nil), rollups)
		}
	})
...
func TestBandwidthDailyRollups(t *testing.T) {
	storagenodedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db storagenode.DB) {
		...
		addBandwidth := func(day time.Time, satellite storx.NodeID, r *bandwidth.UsageRollup) {
		...
		usageRollups := make(map[storx.NodeID]map[time.Time]*bandwidth.UsageRollup)
...
func TestBandwidthRollup(t *testing.T) {
	storagenodedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db storagenode.DB) {
		...
		testID1 := storx.NodeID{1}
		testID2 := storx.NodeID{2}
		testID3 := storx.NodeID{3}
