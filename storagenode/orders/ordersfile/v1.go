...
func OpenWritableV1(path string, satelliteID storx.NodeID, creationTime time.Time) (Writable, error) {
...
func (of *fileV1) writeHeader(satelliteID storx.NodeID, creationTime time.Time) error {
	toWrite := fileMagic[:]
