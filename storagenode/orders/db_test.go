...
func TestDB(t *testing.T) {
	storagenodedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db storagenode.DB) {
		...
		storagenode := testidentity.MustPregeneratedSignedIdentity(0, storx.LatestIDVersion())

		satellite0 := testidentity.MustPregeneratedSignedIdentity(1, storx.LatestIDVersion())

		piece := storx.NewPieceID()
		...
		expectedGrouped := map[storx.NodeID][]*ordersfile.Info{}
