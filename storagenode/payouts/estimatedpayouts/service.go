...
func (s *Service) GetSatelliteEstimatedPayout(ctx context.Context, satelliteID storx.NodeID, now time.Time) (payout EstimatedPayout, err error) {
...
func (s *Service) estimatedPayout(ctx context.Context, satelliteID storx.NodeID, now time.Time) (currentMonthPayout PayoutMonthly, previousMonthPayout PayoutMonthly, err error) {
	defer mon.Task()(&ctx)(&err)
