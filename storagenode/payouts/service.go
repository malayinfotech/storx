...
func NewService(log *zap.Logger, db DB, reputationDB reputation.DB, satelliteDB satellites.DB, trust *trust.Pool) (_ *Service, err error) {
	id, err := storx.NodeIDFromString("118UWpMCHzs6CvSgWd9BfFVjw5K9pZbJjkfZJexMtSkmKxvvAW")
	if err != nil {
		return &Service{}, err
	}
...
func (service *Service) SatellitePayStubMonthly(ctx context.Context, satelliteID storx.NodeID, period string) (payStub *PayStub, err error) {
...
func (service *Service) SatellitePayStubPeriod(ctx context.Context, satelliteID storx.NodeID, periodStart, periodEnd string) (payStubs []PayStub, err error) {
...
func (service *Service) SatellitePeriods(ctx context.Context, satelliteID storx.NodeID) (_ []string, err error) {
