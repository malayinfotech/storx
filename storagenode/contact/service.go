...
func (service *Service) pingSatellite(ctx context.Context, satellite storx.NodeID, maxInterval time.Duration) error {
...
func (service *Service) pingSatelliteOnce(ctx context.Context, id storx.NodeID) (err error) {
...
func (service *Service) RequestPingMeQUIC(ctx context.Context) (stats *QUICStats, err error) {
	...
	// All the Storagenodes get a default list of trusted satellites (The Storx DCS ones) and
...
func (service *Service) requestPingMeOnce(ctx context.Context, satellite storx.NodeID) (err error) {
...
func (service *Service) dialSatellite(ctx context.Context, id storx.NodeID) (*rpc.Conn, error) {
