...
import (
	...
	"common/rpc"
	"common/storx"
	"storx/storagenode/pricing"
	"storx/storagenode/reputation"
	"storx/storagenode/storageusage"
...
func (s *Service) GetReputationStats(ctx context.Context, satelliteID storx.NodeID) (_ *reputation.Stats, err error) {
...
func (s *Service) GetDailyStorageUsage(ctx context.Context, satelliteID storx.NodeID, from, to time.Time) (_ []storageusage.Stamp, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (s *Service) GetPricingModel(ctx context.Context, satelliteID storx.NodeID) (_ *pricing.Pricing, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (s *Service) dial(ctx context.Context, satelliteID storx.NodeID) (_ *Client, err error) {
	defer mon.Task()(&ctx)(&err)
...
func fromSpaceUsageResponse(resp *pb.DailyStorageUsageResponse, satelliteID storx.NodeID) []storageusage.Stamp {
