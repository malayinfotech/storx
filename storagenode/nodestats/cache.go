...
func (cache *Cache) Run(ctx context.Context) error {
	...
	err := cache.satelliteLoop(ctx, func(satelliteID storx.NodeID) error {
...
func (cache *Cache) CacheReputationStats(ctx context.Context) (err error) {
	...
	return cache.satelliteLoop(ctx, func(satellite storx.NodeID) error {
...
func (cache *Cache) satelliteLoop(ctx context.Context, fn func(id storx.NodeID) error) error {
