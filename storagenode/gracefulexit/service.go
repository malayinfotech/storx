...
func (c *Service) DeletePiece(ctx context.Context, satelliteID storx.NodeID, pieceID storx.PieceID) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (c *Service) DeleteSatelliteData(ctx context.Context, satelliteID storx.NodeID) (err error) {
	defer mon.Task()(&ctx)(&err)
...
// the deleted byte count for the corresponding graceful exit operation.
func (c *Service) deleteSatellitePieces(ctx context.Context, satelliteID storx.NodeID) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (c *Service) ExitFailed(ctx context.Context, satelliteID storx.NodeID, reason pb.ExitFailed_Reason, exitFailedBytes []byte) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (c *Service) ExitCompleted(ctx context.Context, satelliteID storx.NodeID, completionReceipt []byte) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (c *Service) ExitNotPossible(ctx context.Context, satelliteID storx.NodeID) (err error) {
	defer mon.Task()(&ctx)(&err)
