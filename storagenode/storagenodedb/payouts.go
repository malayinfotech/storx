...
func (db *payoutDB) GetPayStub(ctx context.Context, satelliteID storx.NodeID, period string) (_ *payouts.PayStub, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) SatellitesHeldbackHistory(ctx context.Context, id storx.NodeID) (_ []payouts.HeldForPeriod, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) SatellitePeriods(ctx context.Context, satelliteID storx.NodeID) (_ []string, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) SatellitesDisposedHistory(ctx context.Context, satelliteID storx.NodeID) (_ int64, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) GetReceipt(ctx context.Context, satelliteID storx.NodeID, period string) (receipt string, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) GetEarnedAtSatellite(ctx context.Context, id storx.NodeID) (_ int64, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) GetPayingSatellitesIDs(ctx context.Context) (_ []storx.NodeID, err error) {
	defer mon.Task()(&ctx)(&err)
	...
	var satelliteIDs []storx.NodeID
	for rows.Next() {
		var satelliteID storx.NodeID

		err := rows.Scan(&satelliteID)
		if err != nil {
			if errors.Is(err, sql.ErrNoRows) {
				return []storx.NodeID{}, nil
			}
...
func (db *payoutDB) GetSatelliteSummary(ctx context.Context, satelliteID storx.NodeID) (_, _ int64, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) GetSatellitePeriodSummary(ctx context.Context, satelliteID storx.NodeID, period string) (_, _ int64, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) GetSatellitePaystubs(ctx context.Context, satelliteID storx.NodeID) (_ *payouts.PayStub, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) GetSatellitePeriodPaystubs(ctx context.Context, period string, satelliteID storx.NodeID) (_ *payouts.PayStub, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *payoutDB) HeldAmountHistory(ctx context.Context) (_ []payouts.HeldAmountHistory, err error) {
	...
	cache := make(map[storx.NodeID]payouts.HeldAmountHistory)
	...
	for rows.Next() {
		...
		satelliteID, err := storx.NodeIDFromBytes(idBytes)
		if err != nil {
			return nil, ErrPayout.Wrap(err)
		}
