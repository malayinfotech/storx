...
func (db *pieceExpirationDB) SetExpiration(ctx context.Context, satellite storx.NodeID, pieceID storx.PieceID, expiresAt time.Time) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *pieceExpirationDB) DeleteExpiration(ctx context.Context, satelliteID storx.NodeID, pieceID storx.PieceID) (found bool, err error) {
	defer mon.Task()(&ctx)(&err)
...
// from the disk.
func (db *pieceExpirationDB) DeleteFailed(ctx context.Context, satelliteID storx.NodeID, pieceID storx.PieceID, when time.Time) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *pieceExpirationDB) Trash(ctx context.Context, satelliteID storx.NodeID, pieceID storx.PieceID) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *pieceExpirationDB) RestoreTrash(ctx context.Context, satelliteID storx.NodeID) (err error) {
	defer mon.Task()(&ctx)(&err)
