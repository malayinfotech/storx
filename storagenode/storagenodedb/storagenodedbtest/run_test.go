...
func createOrder(t *testing.T, ctx *testcontext.Context) (info *ordersfile.Info) {
	storageNodeIdentity := testidentity.MustPregeneratedSignedIdentity(0, storx.LatestIDVersion())
	satelliteIdentity := testidentity.MustPregeneratedSignedIdentity(1, storx.LatestIDVersion())
