...
func (db *bandwidthDB) Add(ctx context.Context, satelliteID storx.NodeID, action pb.PieceAction, amount int64, created time.Time) (err error) {
...
func (db *bandwidthDB) SatelliteSummary(ctx context.Context, satelliteID storx.NodeID, from, to time.Time) (_ *bandwidth.Usage, err error) {
...
func (db *bandwidthDB) SatelliteEgressSummary(ctx context.Context, satelliteID storx.NodeID, from, to time.Time) (_ *bandwidth.Usage, err error) {
	defer mon.Task()(&ctx, satelliteID, from, to)(&err)
...
func (db *bandwidthDB) SatelliteIngressSummary(ctx context.Context, satelliteID storx.NodeID, from, to time.Time) (_ *bandwidth.Usage, err error) {
	defer mon.Task()(&ctx, satelliteID, from, to)(&err)
...
func (db *bandwidthDB) getSatelliteSummary(ctx context.Context, satelliteID storx.NodeID, from, to time.Time, filter actionFilter) (_ *bandwidth.Usage, err error) {
	defer mon.Task()(&ctx, satelliteID, from, to)(&err)
...
func (db *bandwidthDB) SummaryBySatellite(ctx context.Context, from, to time.Time) (_ map[storx.NodeID]*bandwidth.Usage, err error) {
	defer mon.Task()(&ctx)(&err)

	entries := map[storx.NodeID]*bandwidth.Usage{}
...
func (db *bandwidthDB) GetDailySatelliteRollups(ctx context.Context, satelliteID storx.NodeID, from, to time.Time) (_ []bandwidth.UsageRollup, err error) {
	defer mon.Task()(&ctx, satelliteID, from, to)(&err)
