...
func (db *v0PieceInfoDB) getAllPiecesOwnedBy(ctx context.Context, blobStore storage.Blobs, satelliteID storx.NodeID) ([]v0StoredPieceAccess, error) {
...
func (db *v0PieceInfoDB) WalkSatelliteV0Pieces(ctx context.Context, blobStore storage.Blobs, satelliteID storx.NodeID, walkFunc func(pieces.StoredPieceAccess) error) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *v0PieceInfoDB) Get(ctx context.Context, satelliteID storx.NodeID, pieceID storx.PieceID) (_ *pieces.Info, err error) {
	defer mon.Task()(&ctx)(&err)
	info := &pieces.Info{}
...
func (db *v0PieceInfoDB) Delete(ctx context.Context, satelliteID storx.NodeID, pieceID storx.PieceID) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *v0PieceInfoDB) DeleteFailed(ctx context.Context, satelliteID storx.NodeID, pieceID storx.PieceID, now time.Time) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (v0Access *v0StoredPieceAccess) PieceID() storx.PieceID {
	return v0Access.pieceID
}

// Satellite returns the satellite ID that owns the piece.
func (v0Access *v0StoredPieceAccess) Satellite() (storx.NodeID, error) {
