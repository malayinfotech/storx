...
func (db *pieceSpaceUsedDB) GetPieceTotalsForAllSatellites(ctx context.Context) (_ map[storx.NodeID]pieces.SatelliteUsage, err error) {
	defer mon.Task()(&ctx)(&err)
	...
	totalBySatellite := map[storx.NodeID]pieces.SatelliteUsage{}
	for rows.Next() {
...
func (db *pieceSpaceUsedDB) UpdatePieceTotalsForAllSatellites(ctx context.Context, newTotalsBySatellites map[storx.NodeID]pieces.SatelliteUsage) (err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *pieceSpaceUsedDB) deleteTotalBySatellite(ctx context.Context, satelliteID storx.NodeID) (err error) {
	defer mon.Task()(&ctx)(&err)
