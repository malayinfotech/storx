...
func (db *storageUsageDB) GetDaily(ctx context.Context, satelliteID storx.NodeID, from, to time.Time) (_ []storageusage.Stamp, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (db *storageUsageDB) SatelliteSummary(ctx context.Context, satelliteID storx.NodeID, from, to time.Time) (_, _ float64, err error) {
