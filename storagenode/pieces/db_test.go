...
func TestV0PieceInfo(t *testing.T) {
	storagenodedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db storagenode.DB) {
		...
		satellite1 := testidentity.MustPregeneratedSignedIdentity(1, storx.LatestIDVersion())
		satellite2 := testidentity.MustPregeneratedSignedIdentity(2, storx.LatestIDVersion())

		uplink0 := testidentity.MustPregeneratedSignedIdentity(3, storx.LatestIDVersion())
		uplink1 := testidentity.MustPregeneratedSignedIdentity(4, storx.LatestIDVersion())
		uplink2 := testidentity.MustPregeneratedSignedIdentity(5, storx.LatestIDVersion())

		pieceid0 := storx.NewPieceID()
