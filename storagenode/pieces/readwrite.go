...
func NewWriter(log *zap.Logger, blobWriter storage.BlobWriter, blobs storage.Blobs, satellite storx.NodeID, hashAlgorithm pb.PieceHashAlgorithm) (*Writer, error) {
	w := &Writer{log: log}
