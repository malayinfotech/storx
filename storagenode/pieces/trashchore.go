...
type TrashChore struct {
	...
	satellites map[storx.NodeID]*sync2.Workplace
}
...
func (chore *TrashChore) StartRestore(ctx context.Context, satellite storx.NodeID) error {
...
func (chore *TrashChore) ensurePlace(satellite storx.NodeID) *sync2.Workplace {
	chore.mu.Lock()
