...
func (d *Deleter) Enqueue(ctx context.Context, satelliteID storx.NodeID, pieceIDs []storx.PieceID) (unhandled int) {
	if len(pieceIDs) == 0 {
		return 0
	}
...
func (d *Deleter) deleteOrTrash(ctx context.Context, satelliteID storx.NodeID, pieceID storx.PieceID) {
	var err error
	var errMsg string
	var infoMsg string
