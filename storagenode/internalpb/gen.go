...
var (
	mainpkg = flag.String("pkg", "storx/storagenode/internalpb", "main package name")
...
// storx/drpc/cmd/protoc-gen-drpc
...
func main() {
...

	{
		...
		commonPb := os.Getenv("STORX_COMMON_PB")
		if commonPb == "" {
			commonPb = "../../../common/pb"
		}

		overrideImports := ",Mgoogle/protobuf/timestamp.proto=storx/storx/storagenode/internalpb"
		args := []string{
			"--lint_out=.",
