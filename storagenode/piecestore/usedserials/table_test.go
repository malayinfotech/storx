...
func TestUsedSerials(t *testing.T) {
	...
	node0 := testidentity.MustPregeneratedIdentity(0, storx.LatestIDVersion())
	node1 := testidentity.MustPregeneratedIdentity(1, storx.LatestIDVersion())
...
func createExpirationSerial(originalSerial storx.SerialNumber, expiration time.Time) storx.SerialNumber {
	serialWithExp := storx.SerialNumber{}
