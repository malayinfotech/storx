...
func (store *blobStore) CreateVerificationFile(ctx context.Context, id storx.NodeID) error {
...
func (store *blobStore) VerifyStorageDir(ctx context.Context, id storx.NodeID) error {
