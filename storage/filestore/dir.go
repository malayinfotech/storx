...
func (dir *Dir) CreateVerificationFile(ctx context.Context, id storx.NodeID) error {
...
func (dir *Dir) Verify(ctx context.Context, id storx.NodeID) error {
	...
	if !bytes.Equal(content, id.Bytes()) {
		verifyID, err := storx.NodeIDFromBytes(content)
		if err != nil {
