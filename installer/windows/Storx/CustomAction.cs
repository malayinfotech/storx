    ...
    public class CustomActions
    {
        ...
        public static ActionResult ValidateIdentityDir(Session session)
        {
            ...
            catch (ArgumentException e)
            {
                ...
                session["STORX_IDENTITYDIR_VALID"] = e.Message;
                return ActionResult.Success;
            }

            // Identity dir is valid
            session["STORX_IDENTITYDIR_VALID"] = "1";
            return ActionResult.Success;
        }
        ...
        {
            string wallet = session["STORX_WALLET"];
            ...
            {
                // Wallet is invalid
                session["STORX_WALLET_VALID"] = e.Message;
                return ActionResult.Success;
            }

            // Wallet is valid
            session["STORX_WALLET_VALID"] = "1";
            return ActionResult.Success;
        }
        ...
        public static ActionResult ValidateStorageDir(Session session)
        {
            ...
            catch (ArgumentException e)
            {
                ...
                session["STORX_STORAGEDIR_VALID"] = e.Message;
                return ActionResult.Success;
            }

            // Storage dir is valid
            session["STORX_STORAGEDIR_VALID"] = "1";
            return ActionResult.Success;
        }
        ...
        {
            string storageStr = session["STORX_STORAGE"];
            string storageDir = session["STORAGEDIR"];
            ...
            catch (ArgumentException e)
            {
                ...
                session["STORX_STORAGE_VALID"] = e.Message;
                return ActionResult.Success;
            }

            // Allocated Storage value is valid
            session["STORX_STORAGE_VALID"] = "1";
            return ActionResult.Success;
        }
        ...
        {
            string line = session["STORX_SERVICE_COMMAND"];
