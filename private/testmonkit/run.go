...
//
//	STORX_TEST_MONKIT=json,svg,dir=/home/user/debug/trace
//
...
// Run attaches monkit tracing to the ctx where configuration is taken from STORX_TEST_MONKIT.
...
// EnvConfig loads test monkit configuration from STORX_TEST_MONKIT environment variable.
func EnvConfig(tb testing.TB) Config {
	value := os.Getenv("STORX_TEST_MONKIT")
	if value == "" {
