...
import (
	...
	"private/debug"
	"storx/multinode"
	"storx/multinode/console/server"
	"storx/multinode/multinodedb"
)
...
func (system *Multinode) ID() storx.NodeID { return system.Identity.ID }
...
func (system *Multinode) NodeURL() storx.NodeURL {
	return storx.NodeURL{ID: system.ID(), Address: system.Addr()}
}
