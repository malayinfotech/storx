...
type Config struct {
	...
	IdentityVersion *storx.IDVersion
...
// Planet is a full storx system setup.
type Planet struct {
...
func (planet *Planet) createPeers(ctx context.Context, satelliteDatabases satellitedbtest.SatelliteDatabases) (err error) {
	...
	whitelistedSatellites := make(storx.NodeURLs, 0, len(planet.Satellites))
...
func (planet *Planet) FindNode(nodeID storx.NodeID) *StorageNode {
...
func (planet *Planet) WriteWhitelist(version storx.IDVersion) (string, error) {
