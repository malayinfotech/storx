...
func TestNewOptions(t *testing.T) {
	...
	fi, err := testidentity.PregeneratedIdentity(0, storx.LatestIDVersion())
...
func TestExtensionMap_HandleExtensions(t *testing.T) {
	...
	testidentity.IdentityVersionsTest(t, func(t *testing.T, version storx.IDVersion, _ *identity.FullIdentity) {
