...
func (slow *SlowBlobs) CreateVerificationFile(ctx context.Context, id storx.NodeID) error {
	if err := slow.sleep(ctx); err != nil {
		return errs.Wrap(err)
	}
...
func (slow *SlowBlobs) VerifyStorageDir(ctx context.Context, id storx.NodeID) error {
