...
func (bad *BadBlobs) CreateVerificationFile(ctx context.Context, id storx.NodeID) error {
	if err := bad.err.Err(); err != nil {
		return err
	}
...
func (bad *BadBlobs) VerifyStorageDir(ctx context.Context, id storx.NodeID) error {
	if err := bad.err.Err(); err != nil {
		return err
	}
