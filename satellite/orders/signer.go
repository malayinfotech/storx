...
type Signer struct {
	...
	RootPieceID        storx.PieceID
	rootPieceIDDeriver storx.PieceIDDeriver

	PieceExpiration time.Time
	OrderCreation   time.Time
	OrderExpiration time.Time

	PublicKey  storx.PiecePublicKey
	PrivateKey storx.PiecePrivateKey

	Serial storx.SerialNumber
...
func createSerial(orderExpiration time.Time) (_ storx.SerialNumber, err error) {
	var serial storx.SerialNumber

	binary.BigEndian.PutUint64(serial[0:8], uint64(orderExpiration.Unix()))
	_, err = rand.Read(serial[8:])
	if err != nil {
		return storx.SerialNumber{}, ErrSigner.Wrap(err)
	}
...
func NewSigner(service *Service, rootPieceID storx.PieceID, pieceExpiration time.Time, orderCreation time.Time, limit int64, action pb.PieceAction, bucket metabase.BucketLocation) (*Signer, error) {
	signer := &Signer{}
	...
	var err error
	signer.PublicKey, signer.PrivateKey, err = storx.NewPieceKey()
	if err != nil {
...
func NewSignerGet(service *Service, rootPieceID storx.PieceID, orderCreation time.Time, limit int64, bucket metabase.BucketLocation) (*Signer, error) {
...
func NewSignerDelete(service *Service, rootPieceID storx.PieceID, orderCreation time.Time, bucket metabase.BucketLocation) (*Signer, error) {
...
func NewSignerRepairGet(service *Service, rootPieceID storx.PieceID, orderCreation time.Time, pieceSize int64, bucket metabase.BucketLocation) (*Signer, error) {
...
func NewSignerRepairPut(service *Service, rootPieceID storx.PieceID, pieceExpiration time.Time, orderCreation time.Time, pieceSize int64, bucket metabase.BucketLocation) (*Signer, error) {
...
func NewSignerAudit(service *Service, rootPieceID storx.PieceID, orderCreation time.Time, pieceSize int64, bucket metabase.BucketLocation) (*Signer, error) {
...
func NewSignerGracefulExit(service *Service, rootPieceID storx.PieceID, orderCreation time.Time, shareSize int32, bucket metabase.BucketLocation) (*Signer, error) {
