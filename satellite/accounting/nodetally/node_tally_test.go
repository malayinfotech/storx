...
func correctRedundencyScheme(shareCount int, uplinkRS storx.RedundancyScheme) bool {
...
func satelliteRS(t *testing.T, satellite *testplanet.Satellite) storx.RedundancyScheme {
