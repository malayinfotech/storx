...
func TestRollupNoDeletes(t *testing.T) {
	satellitedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db satellite.DB) {
		...
		nodeData := map[storx.NodeID]float64{}
		bwTotals := make(map[storx.NodeID][]int64)
...
func createNodes(ctx *testcontext.Context, t *testing.T, db satellite.DB) []storx.NodeID {
	storageNodes := []storx.NodeID{}
	for i := 0; i < 10; i++ {
		id := testrand.NodeID()
...
func TestRollupOldOrders(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		func(t *testing.T, ctx *testcontext.Context, planet *testplanet.Planet) {
			...
			// Phase 1
			storageTotalsPhase1 := make(map[storx.NodeID]float64)
			...
			bwTotalsPhase1 := make(map[storx.NodeID][]int64)
			...
			// Phase 2
			storageTotalsPhase2 := make(map[storx.NodeID]float64)
			...
			bwTotalsPhase2 := make(map[storx.NodeID][]int64)
...
func saveBWPhase3(ctx context.Context, ordersDB orders.DB, bwTotals map[storx.NodeID][]int64, intervalStart time.Time) error {
...
func dqNodes(ctx *testcontext.Context, overlayDB overlay.DB, storageNodes []storx.NodeID) (map[storx.NodeID]bool, error) {
	dqed := make(map[storx.NodeID]bool)
