...
type DB interface {
	...
	UpdateVersionAtLeast(ctx context.Context, id storx.NodeID, version Version) error
	...
	// is HasAnything.
	VersionAtLeast(ctx context.Context, id storx.NodeID, version Version) (bool, error)
}
