...
func TestDownloadSharesMissingPiece(t *testing.T) {
	testWithChoreAndObserver(t, testplanet.Config{
		...
		segment.RootPieceID = storx.NewPieceID()
...
func TestAuditRepairedSegmentInExcludedCountries(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		numExcluded := 5
		var nodesInExcluded storx.NodeIDList
...
func TestConcurrentAuditsTimeout(t *testing.T) {
	...
	testWithChoreAndObserver(t, testplanet.Config{
		...
		appearancesPerNode := make(map[storx.NodeID]int)
...
func (b *badBlobsAllowVerify) VerifyStorageDir(ctx context.Context, id storx.NodeID) error {
	return b.goodBlobs.VerifyStorageDir(ctx, id)
}

func (b *badBlobsAllowVerify) CreateVerificationFile(ctx context.Context, id storx.NodeID) error {
