...
func (db *snopayoutsDB) GetPaystub(ctx context.Context, nodeID storx.NodeID, period string) (paystub snopayouts.Paystub, err error) {
...
func (db *snopayoutsDB) GetAllPaystubs(ctx context.Context, nodeID storx.NodeID) (paystubs []snopayouts.Paystub, err error) {
...
func convertDBXPaystub(dbxPaystub *dbx.StoragenodePaystub) (snopayouts.Paystub, error) {
	nodeID, err := storx.NodeIDFromBytes(dbxPaystub.NodeId)
	if err != nil {
		return snopayouts.Paystub{}, Error.Wrap(err)
	}
...
func (db *snopayoutsDB) GetPayment(ctx context.Context, nodeID storx.NodeID, period string) (payment snopayouts.Payment, err error) {
...
func (db *snopayoutsDB) GetAllPayments(ctx context.Context, nodeID storx.NodeID) (payments []snopayouts.Payment, err error) {
...
func convertDBXPayment(dbxPayment *dbx.StoragenodePayment) (snopayouts.Payment, error) {
	nodeID, err := storx.NodeIDFromBytes(dbxPayment.NodeId)
	if err != nil {
		return snopayouts.Payment{}, Error.Wrap(err)
	}
