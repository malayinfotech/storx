...
// Wallets returns database for storxscan wallets.
func (dbc *satelliteDBCollection) Wallets() storxscan.WalletsDB {
	return &storxscanWalletsDB{db: dbc.getByName("storxscan")}
}
...
// StorxscanPayments returns database for storxscan payments.
func (dbc *satelliteDBCollection) StorxscanPayments() storxscan.PaymentsDB {
	return &storxscanPayments{db: dbc.getByName("storxscan_payments")}
}
