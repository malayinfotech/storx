...
func TestGetOfflineNodesForEmail(t *testing.T) {
	satellitedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db satellite.DB) {
		...
		offlineID := teststorx.NodeIDFromString("offlineNode")
		onlineID := teststorx.NodeIDFromString("onlineNode")
		disqualifiedID := teststorx.NodeIDFromString("dqNode")
		exitedID := teststorx.NodeIDFromString("exitedNode")
		offlineNoEmailID := teststorx.NodeIDFromString("noEmail")
...
func TestUpdateLastOfflineEmail(t *testing.T) {
	satellitedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db satellite.DB) {
		...
		nodeID0 := teststorx.NodeIDFromString("testnode0")
		nodeID1 := teststorx.NodeIDFromString("testnode1")
		...
		require.NoError(t, cache.UpdateCheckIn(ctx, checkInInfo, now, selectionCfg))
		require.NoError(t, cache.UpdateLastOfflineEmail(ctx, []storx.NodeID{nodeID0, nodeID1}, now))
...
func TestUpdateCheckInDirectUpdate(t *testing.T) {
	satellitedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db satellite.DB) {
		...
		nodeID := teststorx.NodeIDFromString("testnode0")
		checkInInfo := overlay.NodeCheckInInfo{
			IsUp: true,
			Address: &pb.NodeAddress{
				Address: "1.2.3.4",
...
func TestSetAllContainedNodes(t *testing.T) {
	satellitedbtest.Run(t, func(ctx *testcontext.Context, t *testing.T, db satellite.DB) {
		...
		for _, n := range []storx.NodeID{node1, node2, node3} {
			checkInInfo := overlay.NodeCheckInInfo{
				IsUp:    true,
