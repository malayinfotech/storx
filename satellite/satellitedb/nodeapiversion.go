...
func (db *nodeAPIVersionDB) UpdateVersionAtLeast(ctx context.Context, id storx.NodeID, version nodeapiversion.Version) (err error) {
...
// is HasAnything.
func (db *nodeAPIVersionDB) VersionAtLeast(ctx context.Context, id storx.NodeID, version nodeapiversion.Version) (bool, error) {
