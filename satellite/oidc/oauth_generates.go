...
// UUIDAuthorizeGenerate generates an auth code using Storx's uuid.
...
// MacaroonAccessGenerate provides an access_token and refresh_token generator using Storx's Macaroons.
...
// Token issues access and refresh tokens that are backed by storx's Macaroons. This expects several scopes to be set on
