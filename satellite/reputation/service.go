...
type DB interface {
	...
	Get(ctx context.Context, nodeID storx.NodeID) (*Info, error)
	// ApplyUpdates applies multiple updates (defined by the updates
	// parameter) to a node's reputations record.
	ApplyUpdates(ctx context.Context, nodeID storx.NodeID, updates Mutations, reputationConfig Config, now time.Time) (_ *Info, err error)

	// UnsuspendNodeUnknownAudit unsuspends a storage node for unknown audits.
	UnsuspendNodeUnknownAudit(ctx context.Context, nodeID storx.NodeID) (err error)
	// DisqualifyNode disqualifies a storage node.
	DisqualifyNode(ctx context.Context, nodeID storx.NodeID, disqualifiedAt time.Time, reason overlay.DisqualificationReason) (err error)
	// SuspendNodeUnknownAudit suspends a storage node for unknown audits.
	SuspendNodeUnknownAudit(ctx context.Context, nodeID storx.NodeID, suspendedAt time.Time) (err error)
}
...
func (service *Service) ApplyAudit(ctx context.Context, nodeID storx.NodeID, reputation overlay.ReputationStatus, result AuditType) (err error) {
...
func (service *Service) Get(ctx context.Context, nodeID storx.NodeID) (info *Info, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (service *Service) TestSuspendNodeUnknownAudit(ctx context.Context, nodeID storx.NodeID, suspendedAt time.Time) (err error) {
...
func (service *Service) TestDisqualifyNode(ctx context.Context, nodeID storx.NodeID, reason overlay.DisqualificationReason) (err error) {
...
func (service *Service) TestUnsuspendNodeUnknownAudit(ctx context.Context, nodeID storx.NodeID) (err error) {
...
func (service *Service) FlushNodeInfo(ctx context.Context, nodeID storx.NodeID) (err error) {
	if db, ok := service.db.(*CachingDB); ok {
