...
func (rp *repairPartial) getStatsByRS(redundancy storx.RedundancyScheme) *partialRSStats {
...
func (rp *repairPartial) loadRedundancy(redundancy storx.RedundancyScheme) (int, int, int, int) {
