...
func (service *Service) PingBack(ctx context.Context, nodeurl storx.NodeURL) (_ bool, _ bool, _ string, err error) {
...
func (service *Service) pingNodeQUIC(ctx context.Context, nodeurl storx.NodeURL) error {
