...
```json
{
  ...
  "redirectURL": "http://localhost:8888/oauth/storx/callback",
...
[European Union]: https://github.com/storx/common/blob/main/storx/location/region.go#L14

[European Economic Area]: https://github.com/storx/common/blob/main/storx/location/region.go#L7
