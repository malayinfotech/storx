...
func TestProjectDelete(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		buckets, err := planet.Satellites[0].API.Buckets.Service.ListBuckets(ctx, projectID, storx.BucketListOptions{Limit: 1, Direction: storx.Forward}, macaroon.AllowedBuckets{All: true})
		require.NoError(t, err)
