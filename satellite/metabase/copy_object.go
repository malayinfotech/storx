...
type FinishCopyObject struct {
	...
	NewEncryptedMetadataKeyNonce storx.Nonce
...
func getObjectAtCopySourceAndDestination(
	...
	if !rows.Next() {
		return Object{}, uuid.UUID{}, nil, 0, storx.ErrObjectNotFound.New("source object not found")
	}
	...
	if sourceObject.StreamID != opts.StreamID {
		return Object{}, uuid.UUID{}, nil, 0, storx.ErrObjectNotFound.New("object was changed during copy")
	}
