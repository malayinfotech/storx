		...
		Steps: []*migrate.Step{
			{
				...
				Action: migrate.SQL{
					...
					COMMENT ON COLUMN segments.placement is 'placement is the country or region restriction for the segment data. See storx.PlacementConstraint for the values.';
					...
					COMMENT ON COLUMN node_aliases.node_id    is 'node_id refers to the storx.NodeID';
