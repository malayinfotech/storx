...
func TestSuccess(t *testing.T) {
	testTransfers(t, numObjects, numMultipartObjects, func(t *testing.T, ctx *testcontext.Context, nodeFullIDs map[storx.NodeID]*identity.FullIdentity, satellite *testplanet.Satellite, processClient exitProcessClient, exitingNode *storagenode.Peer, numPieces int) {
...
func TestInvalidStorageNodeSignature(t *testing.T) {
	testTransfers(t, 1, 0, func(t *testing.T, ctx *testcontext.Context, nodeFullIDs map[storx.NodeID]*identity.FullIdentity, satellite *testplanet.Satellite, processClient exitProcessClient, exitingNode *storagenode.Peer, numPieces int) {
		response, err := processClient.Recv()
		require.NoError(t, err)
...
func testFailureHashMismatch(t *testing.T, ctx *testcontext.Context, nodeFullIDs map[storx.NodeID]*identity.FullIdentity, satellite *testplanet.Satellite, processClient exitProcessClient, exitingNode *storagenode.Peer, numPieces int) {
	response, err := processClient.Recv()
	require.NoError(t, err)
...
func TestFailureUplinkSignature(t *testing.T) {
	testTransfers(t, 1, 0, func(t *testing.T, ctx *testcontext.Context, nodeFullIDs map[storx.NodeID]*identity.FullIdentity, satellite *testplanet.Satellite, processClient exitProcessClient, exitingNode *storagenode.Peer, numPieces int) {
		...
		case *pb.SatelliteMessage_TransferPiece:
			...
			orderLimit := header.OrderLimit
			orderLimit.UplinkPublicKey = storx.PiecePublicKey{}
...
func testSuccessSegmentUpdate(t *testing.T, ctx *testcontext.Context, nodeFullIDs map[storx.NodeID]*identity.FullIdentity, satellite *testplanet.Satellite, processClient exitProcessClient, exitingNode *storagenode.Peer, numPieces int) {
	var recNodeID storx.NodeID
...
func testUpdateSegmentFailureDuplicatedNodeID(t *testing.T, ctx *testcontext.Context, nodeFullIDs map[storx.NodeID]*identity.FullIdentity, satellite *testplanet.Satellite, processClient exitProcessClient, exitingNode *storagenode.Peer, numPieces int) {
	response, err := processClient.Recv()
	require.NoError(t, err)

	var firstRecNodeID storx.NodeID
	var pieceID storx.PieceID
	switch m := response.GetMessage().(type) {
	case *pb.SatelliteMessage_TransferPiece:
	...
	pieces := segments[0].Pieces
	pieceMap := make(map[storx.NodeID]int)
	for _, piece := range pieces {
...
func TestFailureStorageNodeIgnoresTransferMessages(t *testing.T) {
	...
	testplanet.Run(t, testplanet.Config{
		...
		nodeFullIDs := make(map[storx.NodeID]*identity.FullIdentity)
...
func testTransfers(t *testing.T, objects int, multipartObjects int, verifier func(t *testing.T, ctx *testcontext.Context, nodeFullIDs map[storx.NodeID]*identity.FullIdentity, satellite *testplanet.Satellite, processClient exitProcessClient, exitingNode *storagenode.Peer, numPieces int)) {
...
func findNodeToExit(ctx context.Context, planet *testplanet.Planet, objects int) (*testplanet.StorageNode, error) {
	...
	pieceCountMap := make(map[storx.NodeID]int, len(planet.StorageNodes))
	for _, node := range planet.StorageNodes {
	...
	var exitingNodeID storx.NodeID
	maxCount := 0
...
func hasDuplicates(pieces metabase.Pieces) bool {
	nodePieceCounts := make(map[storx.NodeID]int)
	for _, piece := range pieces {
