...
func TestOffline(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		result, err := service.KnownUnreliableOrOffline(ctx, []storx.NodeID{
		...
		require.Equal(t, result[0], storx.NodeID{1, 2, 3, 4})
	})
}
...
func TestEnsureMinimumRequested(t *testing.T) {
	...
	testplanet.Run(t, testplanet.Config{
		...
		reputable := map[storx.NodeID]bool{}
...
func TestNodeSelection(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		tests := []struct {
			...
			exclude         func() (excludedNodes []storx.NodeID)
		}{
			{
		...
		for _, tt := range tests {
			...
			var excludedNodes []storx.NodeID
			if tt.exclude != nil {
...
func TestNodeSelectionGracefulExit(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		exitingNodes := make(map[storx.NodeID]bool)
...
func TestFindStorageNodesDistinctNetworks(t *testing.T) {
	...
	testplanet.Run(t, testplanet.Config{
		...
		var excludedNodes storx.NodeIDList
